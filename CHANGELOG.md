...
- The minimum supported rust version (MSRV) was bumped from 1.70.0 to 1.88.0. (See: [The Cargo Book § Semver Compatibility](https://doc.rust-lang.org/cargo/reference/semver.html#env-new-rust))
